...
echo_and_run cd "/Users/alessiature/progetto_workspace/src/rosserial/rosserial_python"
...
echo_and_run /usr/bin/env \
    ...
    "/Users/alessiature/progetto_workspace/src/rosserial/rosserial_python/setup.py" \
     \
    build --build-base "/Users/alessiature/progetto_workspace/build/rosserial/rosserial_python" \
    install \
    --root="${DESTDIR-/}" \
