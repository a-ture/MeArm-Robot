...
echo_and_run cd "/Users/alessiature/progetto_workspace/src/rosserial/rosserial_xbee"
...
echo_and_run /usr/bin/env \
    ...
    "/Users/alessiature/progetto_workspace/src/rosserial/rosserial_xbee/setup.py" \
     \
    build --build-base "/Users/alessiature/progetto_workspace/build/rosserial/rosserial_xbee" \
    install \
    --root="${DESTDIR-/}" \
