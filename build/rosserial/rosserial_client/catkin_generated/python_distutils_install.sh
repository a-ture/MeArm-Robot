...
echo_and_run cd "/Users/alessiature/progetto_workspace/src/rosserial/rosserial_client"
...
echo_and_run /usr/bin/env \
    ...
    "/Users/alessiature/progetto_workspace/src/rosserial/rosserial_client/setup.py" \
     \
    build --build-base "/Users/alessiature/progetto_workspace/build/rosserial/rosserial_client" \
    install \
    --root="${DESTDIR-/}" \
